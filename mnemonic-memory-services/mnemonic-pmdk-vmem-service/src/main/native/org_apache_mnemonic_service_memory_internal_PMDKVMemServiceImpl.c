...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nallocate(JNIEnv* env,
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nreallocate(JNIEnv* env,
...
JNIEXPORT
void JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nfree(
    JNIEnv* env,
...
JNIEXPORT
void JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nsync(
    JNIEnv* env,
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ncapacity(
    JNIEnv* env,
    jobject this, jlong id)
{
  VMPool *pool;
...
JNIEXPORT
jobject JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ncreateByteBuffer(
...
JNIEXPORT
jobject JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nretrieveByteBuffer(
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nretrieveSize(JNIEnv *env,
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ngetByteBufferHandler(
...
JNIEXPORT
jobject JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nresizeByteBuffer(
...
JNIEXPORT
void JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ndestroyByteBuffer(
    JNIEnv *env, jobject this, jlong id, jobject bytebuf) {
  VMPool *pool;
  pthread_rwlock_rdlock(&g_vmem_rwlock);
  pool = g_vmpool_arr + id;
...
JNIEXPORT
void JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nsetHandler(
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ngetHandler(JNIEnv *env,
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nhandlerCapacity(
...
JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ngetBaseAddress(JNIEnv *env,
    jobject this, jlong id) {
  return 0L;
}

JNIEXPORT
jlong JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_ninit(JNIEnv *env, jclass this,
...
JNIEXPORT
void JNICALL Java_org_apache_mnemonic_service_memory_internal_PMDKVMemServiceImpl_nclose
